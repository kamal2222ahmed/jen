...
def switchesForGradle = readFileFromWorkspace('jobs/build/resources/serenityTests/gradleForDigitalEvidenceTestSuite.txt')
...
job("${pipeline}-${jobName}") {
    description(readFileFromWorkspace('jobs/build/resources/serenityTests/DigitalEvidenceDescription.txt'))
    configure { project ->
