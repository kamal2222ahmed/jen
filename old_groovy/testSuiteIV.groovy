...
def jobName = 'IV'
def switchesForGradle = readFileFromWorkspace('jobs/build/resources/serenityTests/gradleForIVTestSuite.txt')
...
job("${pipeline}-${jobName}") {
    description(readFileFromWorkspace('jobs/build/resources/serenityTests/IVDescription.txt'))
    configure { project ->
