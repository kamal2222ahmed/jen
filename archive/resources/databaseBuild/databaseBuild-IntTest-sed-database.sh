...
cd ${WORKSPACE}/Apps/Tests/InternalAppFunctionalTests
sed -i "s/elis2datadevelop/elis2data${DATABASE}develop/g" src/main/resources/META-INF/properties/test.database.properties
