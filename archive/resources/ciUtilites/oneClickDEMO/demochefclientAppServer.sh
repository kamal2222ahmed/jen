...
#deploy ELIS App
knife ssh "chef_environment:${ENVIRONMENT} AND role:Deployable" -C 1 -a ipaddress -x chef "sudo chef-client -j \"http://${NEXUS}/nexus/service/local/artifact/maven/content?r=public&g=gov.dhs.uscis.elis2&a=InternalApp&v=${Version}&p=json\""
