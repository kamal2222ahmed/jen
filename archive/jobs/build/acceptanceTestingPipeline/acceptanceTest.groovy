job('ELIS2-AcceptanceTesting') {
  description(readFileFromWorkspace('resources/acceptanceTesting/acceptanceTestingDescription.txt'))
  jdk('java-1.8.0_u102')
  label('master||BM-compile')
  authorization {
  ...
  steps {
    downstreamParameterized {
      trigger('ELIS2-CLM-Release-Scan, ELIS2-Fortify-BuildFlow') {
       }
     }
  }
  configure { project ->
