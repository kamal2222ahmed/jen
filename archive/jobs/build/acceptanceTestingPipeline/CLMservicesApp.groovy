job('ELIS2-CLM-ServicesApp') {
  description(readFileFromWorkspace('resources/acceptanceTesting/clmsServicesAppDescription.txt'))
  jdk('java-1.8.0_u102')
  ...
  steps {
    shell(readFileFromWorkspace('resources/acceptanceTesting/wgetserivcesApprc.sh'))
  }
  configure { project ->
