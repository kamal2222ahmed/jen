job('ELIS2-CLM-efile') {
  description(readFileFromWorkspace('resources/acceptanceTesting/clmi90Description.txt'))
  jdk('java-1.8.0_u102')
  ...
  steps {
    shell(readFileFromWorkspace('resources/acceptanceTesting/wgetI90rc.sh'))
  }
  configure { project ->
