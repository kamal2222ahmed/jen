job('ELIS2-StagingGateBuild') {
  ...
  steps {
      shell(readFileFromWorkspace('resources/stagingGateBuild/preDatabaseDeploy.sh'))
      ...
      gradle {
          ...
          switches(readFileFromWorkspace('resources/stagingGateBuild/1clean.txt'))
          tasks('clean')
          useWrapper(false)
      ...
      gradle {
          ...
          passAsProperties(true)
          rootBuildScriptDir('Apps/')
          switches(readFileFromWorkspace('resources/stagingGateBuild/2buildArtifacts.txt'))
      ...
      gradle {
          ...
          passAsProperties(true)
          rootBuildScriptDir('Apps/')
          switches(readFileFromWorkspace('resources/stagingGateBuild/3uploadTheArtifacts.txt'))
      ...
      shell(readFileFromWorkspace('resources/stagingGateBuild/ftPrepare.sh'))
      environmentVariables {
