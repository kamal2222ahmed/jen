job('ELIS2-BuildGateBuild-testSonarInt-Nexus3') {
  ...
  steps {
      ...
      gradle {
          ...
          switches(readFileFromWorkspace('resources/buildGateBuild-testSonarInt/gradle-clean-nexus3.txt'))
          tasks('clean')
          useWrapper(false)
          useWorkspaceAsHome(true)
      }
      gradle {
          ...
          passAsProperties(true)
          rootBuildScriptDir('Apps/')
          switches(readFileFromWorkspace('resources/buildGateBuild-testSonarInt/gradle-build-test-sonar-nexus3.txt'))
