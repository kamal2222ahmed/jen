job('launchFT-app1') {
  ...
  steps {
      shell(readFileFromWorkspace('resources/ciUtilites/makeFTpipeline/APPspinUp.sh'))
      environmentVariables {
          propertiesFile('${WORKSPACE}/deploy.properties')
      }
      shell(readFileFromWorkspace('resources/ciUtilites/makeFTpipeline/cleanandServiceStop.sh'))
      shell(readFileFromWorkspace('resources/ciUtilites/makeFTpipeline/chefclientAppServer.sh'))
  }
  publishers {
      archiveArtifacts {
          pattern('conf/**, logs/**')
