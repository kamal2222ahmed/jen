job('Demo_Environment_Creation_IDB1') {
  ...
  steps {
      shell(readFileFromWorkspace('resources/ciUtilites/oneClickDEMO/demoDBspinUP.sh'))
      environmentVariables {
         ...
         gradle {
          ...
          switches(readFileFromWorkspace('resources/ciUtilites/oneClickDEMO/demoDBgradle.txt'))
