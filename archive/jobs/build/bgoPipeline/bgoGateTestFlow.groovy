buildFlowJob('ELIS2-BGO-Test-Flow') {
  description(readFileFromWorkspace('resources/bgoTestFlow/bgoGateTestFlowDescription.txt'))
  jdk('java-1.8.0_u102')
  label('Build-Deploy-Node-Java8')
  buildNeedsWorkspace(true)
  buildFlow(readFileFromWorkspace('resources/bgoTestFlow/groovyDSLbgoBuildGateTestFlow.groovy'))
  authorization {
