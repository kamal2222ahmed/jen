...
def jobName = 'Lockbox'
def switchesForGradle = readFileFromWorkspace('resources/serenityTests/gradleForLockboxTestSuite.txt')
...
job("${pipeline}-${jobName}") {
    description(readFileFromWorkspace('resources/serenityTests/LockboxDescription.txt'))
    authorization {
