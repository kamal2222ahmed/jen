...
def jobName = 'IV'
def switchesForGradle = readFileFromWorkspace('resources/serenityTests/gradleForIVTestSuite.txt')
...
job("${pipeline}-${jobName}") {
    description(readFileFromWorkspace('resources/serenityTests/IVDescription.txt'))
    authorization {
