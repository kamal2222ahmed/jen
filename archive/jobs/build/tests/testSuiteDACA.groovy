...
def jobName = 'DACA'
def switchesForGradle = readFileFromWorkspace('resources/serenityTests/gradleForDACATestSuite.txt')
...
job("${pipeline}-${jobName}") {
    description(readFileFromWorkspace('resources/serenityTests/DACADescription.txt'))
    authorization {
