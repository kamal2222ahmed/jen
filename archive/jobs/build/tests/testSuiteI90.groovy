...
def jobName = 'I90'
def switchesForGradle = readFileFromWorkspace('resources/serenityTests/gradleForI90TestSuite.txt')
...
job("${pipeline}-${jobName}") {
    description(readFileFromWorkspace('resources/serenityTests/i90Description.txt'))
    authorization {
