...
def jobName = 'I131'
def switchesForGradle = readFileFromWorkspace('resources/serenityTests/gradleForI131TestSuite.txt')
...
job("${pipeline}-${jobName}") {
    description(readFileFromWorkspace('resources/serenityTests/I131Description.txt'))
    authorization {
