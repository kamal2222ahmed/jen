...
def switchesForGradle = readFileFromWorkspace('resources/serenityTests/gradleForDigitalEvidenceTestSuite.txt')
...
job("${pipeline}-${jobName}") {
    description(readFileFromWorkspace('resources/serenityTests/DigitalEvidenceDescription.txt'))
    authorization {
