...
def jobName = 'N336'
def switchesForGradle = readFileFromWorkspace('resources/serenityTests/gradleForN336.txt')
...
job("${pipeline}-${jobName}") {
    description(readFileFromWorkspace('resources/serenityTests/N336Description.txt'))
    authorization {
