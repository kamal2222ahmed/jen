...
def jobName = 'N600'
def switchesForGradle = readFileFromWorkspace('resources/serenityTests/gradleForN600.txt')
...
job("${pipeline}-${jobName}") {
    description(readFileFromWorkspace('resources/serenityTests/N600Description.txt'))
    authorization {
    ...
    steps {
        ...
        gradle {
            ...
            tasks('clean cucumberMonkey test activeMQPrinter aggregate')
            useWrapper(false)
