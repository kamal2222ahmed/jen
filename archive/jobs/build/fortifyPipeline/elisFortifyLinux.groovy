job('ELIS-Fortify-Linux-2') {
 ...
 multiscm {
  ...
  steps {
      shell(readFileFromWorkspace('resources/fortifyScan/getLatestRClinux.sh'))
  ...
  conditionalSteps {
     condition {
      ...
      gradle {
        ...
        switches(readFileFromWorkspace('resources/fortifyScan/fortifyCleanlinux.txt'))
   ...
   conditionalSteps {
     condition {
      ...
      gradle {
          ...
          passAsProperties(true)
          rootBuildScriptDir('Apps/')
          switches(readFileFromWorkspace('resources/fortifyScan/fortifyUploadlinux.txt'))
