buildFlowJob('ELIS2-VERIFY-FT') {
  description(readFileFromWorkspace('resources/verifyFTpieline/verifyFTdescription.txt'))
  jdk('java-1.8.0_u102')
  label('Build-Deploy-Node-Java8')
  buildNeedsWorkspace(true)
  buildFlow(readFileFromWorkspace('resources/verifyFTpieline/groovyDSLverifyFT.groovy'))
  authorization {
