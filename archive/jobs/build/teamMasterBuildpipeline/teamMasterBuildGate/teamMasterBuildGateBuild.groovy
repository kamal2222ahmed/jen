job('Test-Team-ELIS2-BuildGate') {
  description(readFileFromWorkspace('resources/teamMasterBuildGateBuild/teamBuildGateBuildDescription.txt'))
  jdk('java-1.8.0_u102')
  ...
  steps {
      shell(readFileFromWorkspace('resources/teamMasterBuildGateBuild/teambranchCheck.sh'))
      ...
      gradle {
          ...
          switches(readFileFromWorkspace('resources/teamMasterBuildGateBuild/1clean.txt'))
          tasks('clean')
          useWrapper(false)
          useWorkspaceAsHome(true)
      }
      shell(readFileFromWorkspace('resources/teamMasterBuildGateBuild/npm-cache.sh'))
      gradle {
          description('build artifacts')
          gradleName('gradle-2.7')
          passAsProperties(true)
          rootBuildScriptDir('Apps/')
          switches(readFileFromWorkspace('resources/teamMasterBuildGateBuild/2buildArtifacts.txt'))
      ...
      gradle {
          ...
          passAsProperties(true)
          rootBuildScriptDir('Apps/')
          switches(readFileFromWorkspace('resources/teamMasterBuildGateBuild/3uploadArtifacts.txt'))
      ...
      shell(readFileFromWorkspace('resources/teamMasterBuildGateBuild/teamFTbranchCheck.sh'))
      environmentVariables {
  ...
  publishers {
      ...
      postBuildScripts {
        steps {
          shell(readFileFromWorkspace("resources/teamMasterBuildGateBuild/updateteamFTpool.sh"))
        }
     }
  }
  configure { project ->
