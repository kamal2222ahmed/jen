job('ELIS2-DEMO-Mock-Lockbox-Deploy') {
  description(readFileFromWorkspace('resources/demoPipeline/demolockbox/demoLockboxDeployDescription.txt'))
  jdk('java-1.8.0_u102')
  ...
  steps {
      shell(readFileFromWorkspace('resources/demoPipeline//demolockbox/preDeployDEMOLOCKBOX.sh'))
   ...
   publishers {
      extendedEmail {
        triggers {
          failure {
            content(readFileFromWorkspace('resources/demoPipeline/demolockbox/demoLOCKBOXemailFailureContent.txt'))
          ...
          success {
            content(readFileFromWorkspace('resources/demoPipeline/demolockbox/demoLOCKBOXemailSuccessContent.txt'))
            ...
            sendTo {
              developers()
              recipientList()
            subject('Deployment of Master Build Version ${BTAR_VERSION} to the Demo Lockbox Server is complete')
             }
          }
        }
      }
