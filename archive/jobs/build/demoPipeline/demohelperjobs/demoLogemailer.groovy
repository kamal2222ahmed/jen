job('DEMO-Log-Emailer') {
  description(readFileFromWorkspace('resources/demoPipeline/logRetrieverDescription.txt'))
  jdk('java-1.8.0_u102')
  ...
  parameters {
   ...
   steps {
      shell(readFileFromWorkspace('resources/demoPipeline/logRetriver.txt'))
   }
  configure { project ->
