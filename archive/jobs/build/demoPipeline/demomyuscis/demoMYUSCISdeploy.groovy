job('ELIS2-DEMO-Mock-MyUSCIS-Deploy') {
  description(readFileFromWorkspace('resources/demoPipeline/demomyuscis/demoMYUSCISDeployDescription.txt'))
  jdk('java-1.8.0_u102')
  ...
  steps {
      shell(readFileFromWorkspace('resources/demoPipeline/demomyuscis/preDeployDEMOMYUSCIS.sh'))
    ...
    publishers {
      extendedEmail {
        triggers {
          failure {
            content(readFileFromWorkspace('resources/demoPipeline/demomyuscis/demoMYUSCISemailFailureContent.txt'))
          ...
          success {
            content(readFileFromWorkspace('resources/demoPipeline/demomyuscis/demoMYUSCISemailSuccessContent.txt'))
            ...
            sendTo {
              developers()
              recipientList()
            subject('Deployment of Master Build Version ${BTAR_VERSION} to the Demo MYUSCIS Server is complete')
             }
          }
        }
      }
