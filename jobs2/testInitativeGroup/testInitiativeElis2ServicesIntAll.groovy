job('ELIS2-TestInitiative-Elis2Services-Integration-All') {
  ...
  steps {
      ...
      gradle {
          ...
          tasks(':Backend:Elis2Services:intTest runGulpFullNoInstall :Database:clean :Database:build :Workspace:javakeystore:createJKS -x sonarqube -x buildRpm -x runGulpFull')
          useWrapper(false)
          useWorkspaceAsHome(true)
      }
  }
