job('ELIS2-TestInitiative-Elis2Services-Integration-Large') {
  ...
  steps {
      ...
      gradle {
          ...
          tasks(':Backend:Elis2Services:intTest -PtestType=largeTests runGulpFullNoInstall :Database:clean :Database:build :Workspace:javakeystore:createJKS -x sonarqube -x buildRpm -x runGulpFull')
          useWrapper(false)
          useWorkspaceAsHome(true)
      }
  }
