job('ELIS2-TestInitiative-Elis2Services-Unit') {
  ...
  steps {
      ...
      gradle {
          ...
          tasks(':noINT :BackEnd:Elis2Services:build runGulpFullNoInstall :Database:clean :Database:build :Workspace:javakeystore:createJKS -x sonarqube -x buildRpm -x runGulpFull')
          useWrapper(false)
          useWorkspaceAsHome(true)
      }
  }
