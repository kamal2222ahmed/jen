job('ELIS2-anyBranchGateBuild') {
  description(readFileFromWorkspace('resources2/anyBranch/anyBranchGateBuild/anyBranchGateBuildDescription.txt'))
  jdk('java-1.8.0_u121')
  concurrentBuild()
  label('npm-java8-builder-121')
  authorization {
  ...
  steps {
      shell(readFileFromWorkspace('resources2/anyBranch/anyBranchGateBuild/preDatabaseDeploy.sh'))
      ...
      gradle {
          ...
          switches(readFileFromWorkspace('resources2/anyBranch/anyBranchGateBuild/1clean.txt'))
          tasks('clean')
          useWrapper(false)
          useWorkspaceAsHome(true)
      }
      shell(readFileFromWorkspace('resources2/anyBranch/anyBranchGateBuild/npm-cache.sh'))
      gradle {
          description('build artifacts')
          gradleName('gradle-2.7')
          passAsProperties(true)
          rootBuildScriptDir('Apps/')
          switches(readFileFromWorkspace('resources2/anyBranch/anyBranchGateBuild/2buildArtifacts.txt'))
      ...
      gradle {
          ...
          passAsProperties(true)
          rootBuildScriptDir('Apps/')
          switches(readFileFromWorkspace('resources2/anyBranch/anyBranchGateBuild/3uploadTheArtifacts.txt'))
          tasks('uploadAll :Database:uploadArchives uploadAllS3 uploadAllS3 -x karma -x :Database:baselineResources -x test -x :Database:baseline -x intTest -x runGulpFull -x compileJava -x jar -x war')
          useWrapper(false)
          useWorkspaceAsHome(true)
      }
      ...
      downstreamParameterized {
        ...
        trigger('ELIS2-anyBranchGate-Tests') {
          block {
