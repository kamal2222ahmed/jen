job('ELIS2-anyBranchGateBuild-testSonarInt') {
  description(readFileFromWorkspace('resources2/anyBranch/anyBranchGateBuildTestSonarInt/anyBranchGateBuild-testSonarIntDescription.txt'))
  jdk('java-1.8.0_u121')
  concurrentBuild()
  label('npm-java8-tester-121')
  authorization {
  ...
  steps {
      shell(readFileFromWorkspace('resources2/anyBranch/anyBranchGateBuildTestSonarInt/anyBranchGateBuild-testSonarInt-1.sh'))
      ...
      gradle {
          ...
          switches(readFileFromWorkspace('resources2/anyBranch/anyBranchGateBuildTestSonarInt/gradle-database-clean-jar.txt'))
          tasks('clean jar')
          useWrapper(false)
          useWorkspaceAsHome(true)
      }
      shell(readFileFromWorkspace('resources2/anyBranch/anyBranchGateBuildTestSonarInt/anyBranchGateBuild-testSonarInt-sed-database.txt'))
      gradle {
          description('clean')
          gradleName('gradle-2.7')
          passAsProperties(true)
          rootBuildScriptDir('Apps/')
          switches(readFileFromWorkspace('resources2/anyBranch/anyBranchGateBuildTestSonarInt/gradle-clean.txt'))
          tasks('clean')
          useWrapper(false)
          useWorkspaceAsHome(true)
      }
      gradle {
          ...
          passAsProperties(true)
          rootBuildScriptDir('Apps/')
          switches(readFileFromWorkspace('resources2/anyBranch/anyBranchGateBuildTestSonarInt/gradle-build-test-sonar.txt'))
