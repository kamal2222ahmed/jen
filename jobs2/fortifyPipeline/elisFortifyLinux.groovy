job('ELIS-Fortify-Linux-2') {
 ...
 multiscm {
  ...
  steps {
      shell(readFileFromWorkspace('resources2/fortifyScan/getLatestRClinux.sh'))
  ...
  conditionalSteps {
     condition {
      ...
      gradle {
        ...
        switches(readFileFromWorkspace('resources2/fortifyScan/fortifyCleanlinux.txt'))
   ...
   conditionalSteps {
     condition {
      ...
      gradle {
          ...
          passAsProperties(true)
          rootBuildScriptDir('Apps/')
          switches(readFileFromWorkspace('resources2/fortifyScan/fortifyUploadlinux.txt'))
