buildFlowJob('ELIS2-BuildGate-Tests') {
  description(readFileFromWorkspace('resources2/ciPipeline/buildGate/buildGateTestFlow/buildGateTestFlowDescription.txt'))
  jdk('java-1.8.0_u102')
  label('Build-Deploy-Node-Java8')
  buildNeedsWorkspace(true)
  concurrentBuild()
  buildFlow(readFileFromWorkspace('resources2/ciPipeline/buildGate/buildGateTestFlow/groovyDSLBuildGateTestFlow.groovy'))
  authorization {
