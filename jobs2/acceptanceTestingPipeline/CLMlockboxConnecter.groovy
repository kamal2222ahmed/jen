job('ELIS2-CLM-LockboxConnector') {
  description(readFileFromWorkspace('resources2/acceptanceTesting/clmlockboxConnectorDescription.txt'))
  jdk('java-1.8.0_u102')
  ...
  steps {
    shell(readFileFromWorkspace('resources2/acceptanceTesting/wgetlockboxConnectorrc.sh'))
  }
  configure { project ->
    def slack = project / 'builders' / 'com.sonatype.insight.ci.hudson.PreBuildScan' {
      billOfMaterialsToken('LBC')
      pathConfig {
        scanTargets('lockbox**')
      }
