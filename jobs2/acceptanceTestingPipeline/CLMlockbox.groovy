job('ELIS2-CLM-Lockbox') {
  description(readFileFromWorkspace('resources2/acceptanceTesting/clmlockboxDescription.txt'))
  jdk('java-1.8.0_u102')
  ...
  steps {
    shell(readFileFromWorkspace('resources2/acceptanceTesting/wgetlockboxrc.sh'))
  }
  configure { project ->
    def slack = project / 'builders' / 'com.sonatype.insight.ci.hudson.PreBuildScan' {
      billOfMaterialsToken('LB')
      pathConfig {
        scanTargets('lockbox**')
      }
