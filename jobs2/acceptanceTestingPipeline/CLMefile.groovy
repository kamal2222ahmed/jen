job('ELIS2-CLM-efile') {
  description(readFileFromWorkspace('resources2/acceptanceTesting/clmi90Description.txt'))
  jdk('java-1.8.0_u102')
  ...
  steps {
    shell(readFileFromWorkspace('resources2/acceptanceTesting/wgetI90rc.sh'))
  }
  configure { project ->
    def slack = project / 'builders' / 'com.sonatype.insight.ci.hudson.PreBuildScan' {
      billOfMaterialsToken('XAS')
      pathConfig {
        scanTargets('I90App**')
      }
