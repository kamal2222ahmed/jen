job('AETAS-BuildGateBuild-testSonarInt') {
  description('Test Job for removing a configuration from apps repo InternalAppFunctionalTests permanently')
  jdk('java-1.8.0_u102')
  concurrentBuild()
  ...
  steps {
      ...
      shell(readFileFromWorkspace('resources2/ciPipeline/buildGate/buildGateBuildTestSonarInt/AETASbuildGateBuildSonarInt/AETAS-buildGateBuild-testSonarInt-sed-database.txt'))
      gradle {
          description('clean')
          gradleName('gradle-2.7')
          passAsProperties(true)
