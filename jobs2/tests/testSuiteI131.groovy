...
def jobName = 'I131'
def switchesForGradle = readFileFromWorkspace('resources2/serenityTests/gradleForI131TestSuite.txt')
...
job("${pipeline}-${jobName}") {
    description(readFileFromWorkspace('resources2/serenityTests/I131Description.txt'))
    authorization {
    ...
    steps {
      if (pipeline == "ELIS2-Team-TestSuite") {
        ...
        gradle {
            ...
            if (pipeline == "ELIS2-Team-TestSuite") {
                switches(readFileFromWorkspace('resources2/serenityTests/teamgradleForI131TestSuite.txt'))
            } else {
