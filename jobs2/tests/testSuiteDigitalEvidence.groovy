...
def jobName = 'DigitalEvidence'
def switchesForGradle = readFileFromWorkspace('resources2/serenityTests/gradleForDigitalEvidenceTestSuite.txt')
...
job("${pipeline}-${jobName}") {
    description(readFileFromWorkspace('resources2/serenityTests/DigitalEvidenceDescription.txt'))
    authorization {
    ...
    steps {
      if (pipeline == "ELIS2-Team-TestSuite") {
        ...
        gradle {
            ...
            if (pipeline == "ELIS2-Team-TestSuite") {
                switches(readFileFromWorkspace('resources2/serenityTests/teamgradleForDigitalEvidenceTestSuite.txt'))
            } else {
