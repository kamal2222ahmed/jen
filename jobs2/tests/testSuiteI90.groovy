...
def jobName = 'I90'
def switchesForGradle = readFileFromWorkspace('resources2/serenityTests/gradleForI90TestSuite.txt')
def afterGroovyScript = readFileFromWorkspace('resources2/serenityTests/serenityAfterTestReport.txt')
def elis_pipelines = ["ELIS2-VerifyTest", "ELIS2-HF-TS", "ELIS2-TestSuite", "DB-TestSuite", "ELIS2-Team-TestSuite", "ELIS2-Team-TestSuite", "ELIS2-BGO-TestSuite"]
elis_pipelines.each {pipeline ->
job("${pipeline}-${jobName}") {
    description(readFileFromWorkspace('resources2/serenityTests/i90Description.txt'))
    authorization {
    ...
    parameters {
        ...
        stringParam('MAX_PARALLEL_FORKS', '2')
    ...
    steps {
      if (pipeline == "ELIS2-Team-TestSuite") {
        ...
        gradle {
            ...
            if (pipeline == "ELIS2-Team-TestSuite") {
                switches(readFileFromWorkspace('resources2/serenityTests/teamgradleForI90TestSuite.txt'))
            } else {
