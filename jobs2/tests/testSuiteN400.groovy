...
def jobName = 'N400'
def switchesForGradle = readFileFromWorkspace('resources2/serenityTests/gradleForN400TestSuite.txt')
...
job("${pipeline}-${jobName}") {
    description(readFileFromWorkspace('resources2/serenityTests/N400Description.txt'))
    authorization {
    ...
    parameters {
        ...
        stringParam('MAX_PARALLEL_FORKS', '3')
    ...
    publishers {
        ...
        groovyPostBuild {
            script(readFileFromWorkspace('resources2/serenityTests/serenityAfterTestReport.txt'))
            sandbox(true)
        }
    }
    steps {
      if (pipeline == "ELIS2-Team-TestSuite") {
        ...
        gradle {
            ...
            if (pipeline == "ELIS2-Team-TestSuite") {
                switches(readFileFromWorkspace('resources2/serenityTests/teamgradleForN400TestSuite.txt'))
            } else {
