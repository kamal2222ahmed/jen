job('Demo-Property-File-Emailer') {
  description(readFileFromWorkspace('resources2/demoPipeline/propertyRetrieverDescription.txt'))
  jdk('java-1.8.0_u102')
  ...
  parameters {
   ...
   steps {
      shell(readFileFromWorkspace('resources2/demoPipeline/propertyRetriver.txt'))
   }
  configure { project ->
