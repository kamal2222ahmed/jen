job('ELIS2-DEMO-Live-Deploy') {
  description(readFileFromWorkspace('resources2/demoPipeline/demolive/demoLiveDeployDescription.txt'))
  jdk('java-1.8.0_u102')
  ...
  parameters {
    ...
    stringParam("DB_USER", "ELIS2DATADEMOLVDEVELOP")
  }
  multiscm {
    git {
      remote {
  ...
  steps {
      shell(readFileFromWorkspace('resources2/demoPipeline/demolive/preDeployDEMOLIVE.sh'))
    ...
    publishers {
      extendedEmail {
        triggers {
          failure {
            content(readFileFromWorkspace('resources2/demoPipeline/demolive/demoLIVEemailFailureContent.txt'))
          ...
          success {
            content(readFileFromWorkspace('resources2/demoPipeline/demolive/demoLIVEemailSuccessContent.txt'))
            ...
            sendTo {
              developers()
              recipientList()
            subject('Deployment of Master Build Version ${ELIS2_VERSION} to the Demo Live Server is complete')
             }
          }
        }
      }
