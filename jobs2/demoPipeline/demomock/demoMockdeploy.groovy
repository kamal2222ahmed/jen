job('ELIS2-DEMO-Mock-Deploy') {
  description(readFileFromWorkspace('resources2/demoPipeline/demomock/demoMockDeployDescription.txt'))
  jdk('java-1.8.0_u102')
  ...
  steps {
      shell(readFileFromWorkspace('resources2/demoPipeline/demomock/preDeployDEMOMOCK.sh'))
    ...
    publishers {
      extendedEmail {
        triggers {
          failure {
            content(readFileFromWorkspace('resources2/demoPipeline/demomock/demoMOCKemailFailureContent.txt'))
            recipientList('')
            sendTo {
              developers()
              culprits()
          ...
          success {
            content(readFileFromWorkspace('resources2/demoPipeline/demomock/demoMOCKemailSuccessContent.txt'))
            ...
            sendTo {
              developers()
              recipientList()
            subject('Deployment of Master Build Version ${ELIS2_VERSION} to the Demo Mock Server is complete')
             }
          }
        }
      }
