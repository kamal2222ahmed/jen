...
echo ${BRANCH_NAME}
/opt/chefdk/embedded/bin/ruby ${WORKSPACE}/cloudops/amimaker/amimaker.rb -c tomcat_base-ami_sv.yml -e ${ENVIRONMENT} -r "${RELEASE_CANDIDATE}" "${DEBUG}" | sudo tee output.txt
