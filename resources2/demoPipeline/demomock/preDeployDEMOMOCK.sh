...
if [ -z $ELIS2_VERSION ];
then
   echo "We are going to deploy the latest integration gate build, $LATEST_INTEGRATION, for you to the Demo Mock Server!"
   ELIS2_VERSION=$LATEST_INTEGRATION
else
      echo "We are going to deploy the Version $ELIS2_VERSION, for you to the Demo Mock Server!"
fi
