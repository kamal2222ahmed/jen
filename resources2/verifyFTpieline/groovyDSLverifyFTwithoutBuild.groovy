...
parallel(
  ...
  { build ("ELIS2-VerifyTest-TPS", GIT_BRANCH_NAME: params["BTAR_VERSION"], NEXUS_ID: params["NEXUS_ID"], BUILD_VERSION: params["BUILD_VERSION"], ENVIRONMENT: params["ENVIRONMENT"], IS_SNAPSHOT: false) }
  )
